...
export async function GET(
  ...
  try {
    ...
    const pdfStream = await renderToStream(ProformaInvoicePDF({ shipment, buyer: shipment.buyer, user: dbUser, items }));
    ...
    return new NextResponse(buffer, {
      ...
      headers: {
        ...
        "Content-Disposition": `inline; filename="proforma-${shipment.shipmentNumber}.pdf"`,
      },
    });
  } catch (error) {
    console.error(error);
